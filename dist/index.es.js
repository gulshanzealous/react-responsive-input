...
var InputContainer = styled.div.attrs(function (props) {
    return {};
})(_templateObject, function (props) {
    return props._isHovered && css(_templateObject2);
}, function (props) {
    return props._isFocused && css(_templateObject3);
}, function (props) {
    return props._isError && css(_templateObject4);
});
...
var RootContainer = styled.div.attrs(function (props) {
    var ht = '40px';
    if (props.height) {
        ht = props.height + 'px';
    }
